...
function rw_processing() {
	...
	wp_register_script('processing', plugins_url('/js/processing-1.2.3.min.js', __FILE__), false, '1.2.3');
...
function rw_processing_sc($attr, $content) {
	// @since 1.2.1.1
	// echo '<script type="application/processing">'; // for the init.js script
	// $rw_p_sc_replacement = array("<br />", "<br>", "<p>", "</p>");
	// echo str_replace($rw_p_sc_replacement, '', $content); 
	// replace those strings to nothing
	// echo '</script><canvas width="200" height="200"></canvas></div></p> ';
